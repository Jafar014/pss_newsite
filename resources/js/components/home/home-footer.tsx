...
export default function HomeFooter({
    ...
    const sponsorText = 'font-calcio-italiano text-2xl sm:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl text-[#1c1c1c]/80';
    const sponsorBox = 'border border-[#1c1c1c]/15 rounded-xl px-4 py-2 sm:px-6 sm:py-3 lg:px-8 lg:py-4';
        ...
        <footer className="w-full bg-[#f5f5f5] text-[#1c1c1c] h-[calc(100dvh-64px)] sm:h-[calc(100dvh-80px)] lg:h-[calc(100dvh-96px)] border-t border-[#1c1c1c]/30 [content-visibility:auto] [contain-intrinsic-size:auto_400px]">
            <div className="mx-auto max-w-full h-full flex flex-col overflow-hidden">
                ...
                <div className="border-[#1c1c1c]/10 w-full border-b flex-1 flex flex-col">
                    <div className="flex-1 flex flex-col items-center justify-center gap-6 sm:gap-8 md:gap-10 lg:gap-12 xl:gap-14 px-4 sm:px-6 md:px-8 py-4 sm:py-6">
                        <div className="grid grid-cols-2 sm:flex items-center justify-items-center sm:justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10">
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 1</span></div>
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 2</span></div>
                        </div>
                        <div className="grid grid-cols-2 sm:flex items-center justify-items-center sm:justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10">
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 3</span></div>
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 4</span></div>
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 5</span></div>
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 6</span></div>
                        </div>
                        <div className="grid grid-cols-2 sm:flex items-center justify-items-center sm:justify-center gap-3 sm:gap-4 md:gap-6 lg:gap-8 xl:gap-10">
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 7</span></div>
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 8</span></div>
                            <div className={sponsorBox}><span className={sponsorText}>Sponsor 9</span></div>
                        </div>
                    </div>
                </div>
