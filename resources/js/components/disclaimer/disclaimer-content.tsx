export default function DisclaimerContent() {
    return (
        <section className="w-full px-4 sm:px-6 md:px-8 py-12 md:py-16 lg:py-20">
            <div className="mx-auto max-w-4xl">
                <h1 className="font-calcio-italiano text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-[#1c1c1c] uppercase mb-8 md:mb-12">
                    Disclaimer
                </h1>
                ...
                <div className="space-y-6 text-[#1c1c1c]/80 text-sm sm:text-base md:text-lg leading-relaxed">
                    ...
                    <p>
                        ...
                        pengganti situs resmi PSS Sleman.
                    </p>
                    ...
                    <p>
                        Seluruh logo sponsor yang ditampilkan pada situs web ini digunakan semata-mata
                        sebagai elemen desain untuk keperluan portofolio. Penggunaan logo tersebut
                        tidak menunjukkan adanya hubungan kemitraan, afiliasi, dukungan, atau
                        keterkaitan antara pihak klub dengan pemilik merek atau perusahaan yang
                        tercantum. Segala hak atas logo dan merek dagang tetap milik pemiliknya
                        masing-masing.
                    </p>
                    ...
                    <p>
                        Situs ini mungkin menampilkan tautan ke situs eksternal. Tautan tersebut
                    ...
                    <p>
                        Isi disclaimer ini dapat berubah sewaktu-waktu tanpa pemberitahuan sebelumnya.
                        Dengan mengakses dan menggunakan situs ini, Anda dianggap telah menyetujui
                        seluruh ketentuan yang tercantum dalam disclaimer ini.
                    </p>
